        ...
        <form class="needs-validation" novalidate="" method="post">
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" id="Description" placeholder="Input money in hour....." name="Description" required="">
                    <div class="invalid-feedback">
                ...
                <div class="col-12">
                    ...
                    <input type="datetime-local" class="form-control" id="Strt_time"  name="Strt_time" required="">
                    <div class="invalid-feedback">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="Location_start"  name="Location_start" required="">
                    <div class="invalid-feedback">
                        Please enter your shipping address.
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="Location_end"  name="Location_end" required="">
                    <div class="invalid-feedback">
                        Please enter your shipping address.
                    </div>
                </div>
